	...
	<body>
		...
		<div id="show-facebookUser" class="content scaffold-show" role="main">
			...
			<ol class="property-list facebookUser">
				...
				<g:if test="${facebookUserInstance?.email}">
				<li class="fieldcontain">
					<span id="email-label" class="property-label"><g:message code="facebookUser.email.label" default="Email" /></span>
					
						<span class="property-value" aria-labelledby="email-label"><g:fieldValue bean="${facebookUserInstance}" field="email"/></span>
				...
				<li class="fieldcontain">
					<span id="user-label" class="property-label"><g:message code="facebookUser.user.label" default="User" /></span>
						...
						<span class="property-value" aria-labelledby="user-label"><g:link controller="user" action="show" id="${facebookUserInstance?.user?.id}">${facebookUserInstance?.user?.encodeAsHTML()}</g:link></span>
